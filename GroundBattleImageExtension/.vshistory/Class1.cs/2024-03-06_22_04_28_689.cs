    ...
    public class GroundTroopImagePatcher
    {
        ...
        static IEnumerable<MethodBase> TargetMethods()
        {
            var res = AccessTools.GetTypesFromAssembly(typeof(DistantWorlds.Types.UserInterfaceHelper).Assembly)
                .SelectMany(type => type.GetRuntimeMethod("DistantWorlds.Types.UserInterfaceHelper", [typeof(SpriteBatch), typeof(Stride.Core.math)])
                .Where(method => method.Name == "DistantWorlds.Types.UserInterfaceHelper")
                .Cast<MethodBase>();
            return res;
        }
